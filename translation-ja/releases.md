...
| 13      | 8.3 - 8.5 | ２０２６年３月１７日 | ２０２７年第３四半期 | ２０２８年３月１７日  |
...
注目すべき追加要素には、[`#[Middleware]`](/docs/{{version}}/controllers#controller-middleware)や[`#[Authorize]`](/docs/{{version}}/controllers#authorization-attributes)のようなコントローラおよび認可属性のほか、[`#[Tries]`](/docs/{{version}}/queues#max-job-attempts-and-timeout)、[`#[Backoff]`](/docs/{{version}}/queues#dealing-with-failed-jobs)、[`#[Timeout]`](/docs/{{version}}/queues#max-job-attempts-and-timeout)、[`#[FailOnTimeout]`](/docs/{{version}}/queues#failing-on-timeout)といったキュー指向のジョブ制御を含みます。
