...
`Str::fromBase64`メソッドは、指定したBase64文字列をデコードします。
...
また、指定したUUIDが、バージョン（1、3、4、5、6、7、8）のUUID仕様と一致するかをバリデートすることもできます。
...
`Str::counted`メソッドは、単数形の単語文字列を指定した数に基づいて単数形または複数形に変換し、フォーマットした数を結果の先頭に付加します。
...
`fromBase64`メソッドは、指定したBase64文字列をデコードします。
...
`counted`メソッドは、単数形の単語文字列を指定した数に基づいて単数形または複数形に変換し、フォーマットした数を結果の先頭に付加します。
...
必要であれば、第３引数へ別のクロージャを渡すこともできます。文字列が指定値を含んでいない場合、このクロージャを呼び出します。
...
必要であれば、第３引数へ別のクロージャを渡すこともできます。このクロージャは、条件パラメータを`false`と評価した場合に呼び出します。
